...
plt.show()
plt.savefig('percent_of_visitors_apply.png')
...
ax.set_xticks(range(len(app_pivot)))
ax.set_xticklabels(['Fitness Test', 'No Fitness Test'])
ax.set_yticks([0, 0.5, 0.10, 0.15, 0.20])
ax.set_yticklabels(['0%','5%', '10%', '15%', '20%'])
plt.show()
plt.savefig('percent_of_applicants_purchase.png')
...
ax.set_yticklabels(['0%', '5%', '10%', '15%', '20%'])
plt.show()
plt.savefig('percent_of_visitors_purchase.png')
